...
#info-box(" This is a definiton, the word of phrase in bold is the term being defined. They are generally adapter from the literature adn are used for important elements that are not commoin knowledge for photonic engineers.",kind:"definition",
footer: "Definition usually have a source in the footer") \
